const reviews = [
  {
    ...
    date: "3 years ago",
    rating: 5,
    text: "Had excruciating pain from Sciatica nerve, could barely walk at times. After traction, muscle stimulation and sonic penetration treatments he eased the pain and had me walking better. Highly recommend him. Great patient care, listens to what you say and was able to get me in fast! Very kind and caring. Can't thank him enough!",
  },
  {
    initials: "KP",
    name: "Keith Parrish",
    date: "5 years ago",
    rating: 5,
    text: "Dr. Hornaman works like an old time country doctor. He is skilled in his work and he truly cares about his patients. If you haven't been in to see him yet, treat yourself to a wonderful experience.",
  },
  {
    initials: "GF",
    name: "Gerald Fenno",
    date: "4 years ago",
    rating: 5,
    text: "The Dr is always very thorough and always sends me home in better shape. He only has you come back if needed. Is usually able to get you in quickly. Cares about his patients.",
  },
];
      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12">
          ...
          <div className="flex items-center justify-center gap-2 mt-3">
            <StarRating count={5} />
            <span className="text-white/70 text-sm">4.6 · 14 Google Reviews</span>
          </div>
        </div>
            ...
            <div key={r.name} className="bg-white rounded-xl p-6 flex flex-col gap-4 shadow-lg">
              ...
              <div className="flex items-center gap-3 border-t border-gray-100 pt-4">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-xs">{r.date} · Google Review</p>
                </div>
              </div>
            </div>
          ))}
